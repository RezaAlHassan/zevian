...
const NAV_ITEMS = [
  ...
  {
    id: 'goals', label: 'KPIs', href: '/goals',
  ...
  {
    id: 'upload', label: 'Submit', href: '/upload',
    icon: <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><path d="M9 1.5H4a1 1 0 0 0-1 1v11a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V5.5z" /><path d="M9 1.5V5.5h4" /><path d="M8 8v4M6 10h4" /></svg>,
  },
]
