...
export function OnboardingView() {
    ...
    const finishSetup = async () => {
        ...
        try {
            await completeOnboardingAction({
                ...
                // goal data
                goalName: goalName || 'Custom KPI',
                goalInstructions: goalInstructions || customGoalText || 'Custom KPI instructions',
    ...
    const renderStep3 = () => (
        <div style={{ maxWidth: '720px', margin: '0 auto', animation: 'fadeUp 0.4s ease' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', color: colors.accent, fontSize: '11px', fontWeight: 700, textTransform: 'uppercase', marginBottom: '12px' }}>
                <Icon name="target" size={14} /> Step 3: Create KPI
            </div>
            <h1 style={{ fontSize: '32px', fontWeight: 800, marginBottom: '12px', letterSpacing: '-0.5px' }}>Create KPI for {projName || 'this project'}</h1>
            <p style={{ color: colors.text3, fontSize: '15px', marginBottom: '32px', lineHeight: 1.6 }}>KPIs give the evaluation context. Describe what you want to track, and it will build the criteria.</p>
            ...
            <div style={{ padding: '24px', background: colors.surface, border: `1.5px solid ${colors.border}`, borderRadius: '16px' }}>
                ...
                {goalGenerated && (
                    <div style={{ marginTop: '20px', padding: '16px', background: colors.surface2, borderRadius: '12px', animation: 'fadeUp 0.3s ease' }}>
                        <div style={{ fontSize: '13px', fontWeight: 700, color: colors.text, marginBottom: '10px' }}>Generated KPI: {goalName}</div>
    ...
    const renderStep6 = () => {
        ...
        return (
            <div style={{ maxWidth: '540px', margin: '0 auto', animation: 'fadeUp 0.4s ease', textAlign: 'center' }}>
                ...
                <p style={{ color: colors.text3, fontSize: '16px', marginBottom: '40px', lineHeight: 1.6 }}>Your organization, project, and first KPI are ready.</p>
                ...
                <div style={{ background: colors.surface, border: `1px solid ${colors.border}`, borderRadius: '16px', overflow: 'hidden', textAlign: 'left', marginBottom: '32px' }}>
                    ...
                    <div style={{ padding: '20px' }}>
                        ...
                        <SummaryRow label="KPI" value={goalName || 'Custom KPI'} />
                        <SummaryRow label="Cadence" value={frequency} accent />

                        {criteria.length > 0 && (
                            <div style={{ marginTop: '16px', paddingTop: '16px', borderTop: `1px solid ${colors.border}` }}>
                                <div style={{ fontSize: '10px', fontWeight: 700, color: colors.text3, textTransform: 'uppercase', marginBottom: '10px' }}>Criteria</div>
                                {criteria.map((c, i) => (
