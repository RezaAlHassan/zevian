                        ...
                        {selectedProjectId && (
                            <div style={{ borderTop: `1px solid ${colors.border}` }}>
                                <div style={{ padding: '20px 24px 16px', display: 'flex', alignItems: 'center', gap: '10px' }}>
                                    ...
                                    <div>
                                        <div style={{ fontSize: '15px', fontWeight: 800, color: colors.text, letterSpacing: '-0.2px' }}>Select KPI</div>
                                        <div style={{ fontSize: '12px', color: colors.text3, marginTop: '1px' }}>Choose one active KPI to report on for this period.</div>
                                    </div>
                                </div>
